...
const MealsSummary = () => {
    return (
        <section className={classes.mainSum} >
            ...
            <p>
            Bacon ipsum dolor ametpork bacon hamburger corned beef doner swine chislic porchetta short loin. Kevin shank ribeye turducken alcatra cow. Tongue t-bone ham turkey, flank sausage filet mignon drumstick cow.
            </p>
        </section>
    );
};
